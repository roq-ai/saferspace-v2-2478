...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`SaferSpace v2`}</title>

        <meta
          name="description"
          content="Experience SaferSpace v2 - Empowering Users, Streamlining Reports, and Enhancing Safety. A platform where everyone plays a vital role in creating a secure environment."
        />
      </Head>
      <HomeLayout>
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience SaferSpace v2 - Empowering Users, Streamlining Reports, and Enhancing Safety. A platform where everyone plays a vital role in creating a secure environment.`}
            </Text>
            <Box
