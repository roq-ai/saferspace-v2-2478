...
export function ReportListPage(props: ReportListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getReports({
        ...
        order: params.order,
        searchTermKeys: ['type_of_issue.contains', 'description.contains', 'location.contains', 'status.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    ...
    { id: 'type_of_issue', header: 'Type Of Issue', accessorKey: 'type_of_issue' },
